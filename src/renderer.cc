...
void Renderer::draw_ui_box(SDL_Texture* ui_box, int type, SDL_Texture* dst,
                           SDL_FRect* rect) {
  ...
  SDL_RenderTexture(this->sdl_renderer, ui_box, &src_rect, &dst_rect);
  ...
  SDL_RenderTextureTiled(this->sdl_renderer, ui_box, &src_rect, 1.0f,
                         &dst_rect);
